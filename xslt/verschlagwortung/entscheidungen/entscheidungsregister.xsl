...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:num="http://dummy" exclude-result-prefixes="xs num" version="2.0">
    ...
    <xsl:template match="/">
        ...
        <xsl:text>&#xa;</xsl:text><entscheidungsregister><xsl:text>&#xa;</xsl:text>
            ...
            <xsl:call-template name="entscheidungsdaten">
                <xsl:with-param name="gerichtsBezeichnung" select="'OLG Koblenz'"/>
                <xsl:with-param name="ressort" select="'wr'"/>
                <xsl:with-param name="doctype" select="'ent'"/>
            </xsl:call-template>
            <xsl:call-template name="entscheidungsdaten">
            ...
            <xsl:call-template name="entscheidungsdaten">
                <xsl:with-param name="gerichtsBezeichnung" select="'LG Berlin'"/>
                <xsl:with-param name="ressort" select="'wr'"/>
                <xsl:with-param name="doctype" select="'ent'"/>
            </xsl:call-template>
            <xsl:call-template name="entscheidungsdaten">
            ...
            <xsl:call-template name="entscheidungsdaten">
                <xsl:with-param name="gerichtsBezeichnung" select="'VGH Bayern'"/>
                <xsl:with-param name="ressort" select="'wr'"/>
                <xsl:with-param name="doctype" select="'ent'"/>
            </xsl:call-template>
            <xsl:call-template name="entscheidungsdaten">
            ...
            <xsl:call-template name="entscheidungsdaten">
                <xsl:with-param name="gerichtsBezeichnung" select="'AG Hannover'"/>
                <xsl:with-param name="ressort" select="'wr'"/>
                <xsl:with-param name="doctype" select="'ent'"/>
            </xsl:call-template>
            <xsl:call-template name="entscheidungsdaten">
            ...
            <xsl:call-template name="entscheidungsdaten">
                <xsl:with-param name="gerichtsBezeichnung" select="'AG Nürnberg'"/>
                <xsl:with-param name="ressort" select="'wr'"/>
                <xsl:with-param name="doctype" select="'ent'"/>
            </xsl:call-template>
