...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="ZEITSCHRIFT-BEITRAG">
        ...
        <gh rawid="{@SIRIUS-ID}">
            <xsl:attribute name="docid">
                <xsl:value-of select="concat('BWP', $sevenDigitID)"/>
            </xsl:attribute>
            ...
            <metadata>
                ...
                <ressort>bw</ressort>
                <pub>
                    <pubtitle>Bewertungspraktiker</pubtitle>
                    <pubabbr>BWP</pubabbr>
                    <pubyear>
                ...
                <all_source level="2">bwp</all_source>
    ...
    <xsl:template match="VOLLTEXT">
        ...
        <xsl:value-of select="saxon:parse-html(substring-after(text(),'&lt;br&gt;&lt;br&gt;'))"/>
    </xsl:template>
