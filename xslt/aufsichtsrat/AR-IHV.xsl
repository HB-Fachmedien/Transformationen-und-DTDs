                                ...
                                <div class="ihv_level1">
                                    ...
                                    <div class="ihv_level2">
                                        ...
                                        <xsl:for-each-group select="$aktuelles-Heft" group-adjacent="*[1]/name()" >
                                            ...
                                            <xsl:for-each select="nr/metadata[title!='Aktuelle Fachbeiträge'][1]">
    ...
    <xsl:template name="listarticlesXQ">
        <xsl:for-each select="current-group()">                                                        
            ...
            <a target="_blank" href="https://recherche.aufsichtsrat.de/document.aspx?docid=XQ{$siriusID}">
                ...
                <xsl:if test="/*/metadata/summary"><div class="ihv_abstract"><xsl:value-of select="/*/metadata/summary"/></div></xsl:if>
                <div class="ihv_seite" style="font-style: italic; padding-right: 5px; color: #666666; margin-bottom: 30px; text-align: left;">
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <xsl:value-of select="/*/metadata/pub/pages/start_page"/> &#x2011; <xsl:value-of select="/*/metadata/pub/pages/last_page"/>,  <xsl:text>XQ</xsl:text>
    ...
    <xsl:for-each select="current-group()">                                                        
        ...
        <a target="_blank" href="https://recherche.aufsichtsrat.de/document.aspx?docid=AR{$siriusID}">
            ...
            <div class="ihv_seite" style="font-style: italic; padding-right: 5px; color: #666666; margin-bottom: 30px; text-align: left;">
                <xsl:choose>
                    <xsl:when test="/*/metadata/pub/pages[start_page = last_page]">
                        <xsl:value-of select="/*/metadata/pub/pages/start_page"/>,  <xsl:text>AR</xsl:text><xsl:value-of select="$siriusID"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <xsl:value-of select="/*/metadata/pub/pages/start_page"/> &#x2011; <xsl:value-of select="/*/metadata/pub/pages/last_page"/>,  <xsl:text>AR</xsl:text>
                        <xsl:value-of select="$siriusID"/>
                    </xsl:otherwise>
                </xsl:choose>
            </div>
