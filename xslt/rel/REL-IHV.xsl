        ...
        <html>
            ...
            <body>
                <div class="content-wrapper">
                    ...
                    <div>Sie suchen das Inhaltsverzeichnis einer älteren Ausgabe von REthinking-Law? <a href="https://rethinking-law.com/zeitschrift/archiv/" target="_blank">
                            <u>Hier finden Sie eine Übersicht aller früheren Ausgaben.</u>
                        </a>
                    </div>
                    <section id="content_innen">
                        ...
                        <xsl:for-each select="$aktuelles-Heft[position()=1]">
                            ...
                            <div class="ihv_abstract">
                                ...
                                <p><xsl:value-of select="substring($temp, 1, 400)"/>...<a target="_blank" style="text-decoration: none; color: #4db36c;" href="https://rethinking-law.owlit.de/document.aspx?docid=REL{$siriusID}"><xsl:text>[Weiterlesen]</xsl:text>
                                    </a></p>
                            </div>
                            <xsl:if test="matches('/*/body/p/text()','Seite\s\d{1,3}')">
                                <a target="_blank" href="https://rethinking-law.owlit.de/document.aspx?docid=REL{$siriusID}">Seite X </a>
                                <!-- hier noch seite ersetzen -->
                            </xsl:if>
                        </xsl:for-each>
